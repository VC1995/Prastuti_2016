                    ...
                    <div class="headings">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-5">
                                <div>
                                    <a href="registration_form.php#sos" style="background:rgba(0,0,0,.7);" class="polo-btn store wow animated bounceInUp"><i class="ion-android-checkbox-outline"></i> Register</a>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-5">
