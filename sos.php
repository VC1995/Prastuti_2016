...
<!-- ***************************** Register button ****************** -->
    ...
    <a href="registration_form.php#sos" class="btn btn-primary wow animated bounceInDown" data-wow-delay="1.5s" style="position: fixed; right: 3%; bottom: 3%;font-size: 2em;background: orange;z-index: 5;">Register Now <i class="ion-log-in"></i></a>
    </div>
 <!-- ****************************** Header ************************** -->
        ...
        <section class="container">
            <section class="row" id="logo_menu" role="navigation">                  
                <div class="col-md-3 col-sm-8 col-xs-2 navbar-brand">
                    <span style="font-size: 1.2em;letter-spacing:2px;font-weight:bold;"><a href="index.php"><i class="ion-ios-home" ></i></a> | </span><a class="logo" href=""><i class="ion-ios-home hidden-md hidden-lg"></i><span class="hidden-sm hidden-xs" style="letter-spacing:2px;font-weight:bold;">SOS</span></a>
                </div>
            ...
            <section class="row" style="color:white;text-align:center;">
                <section class="col-md-6 col-sm-6">
                    <div class="team-member wow animated fadeIn legible" data-wow-delay=="0.3s" style="position:relative;">
                        ...
                        <h2 class="wow animated fadeInDown" data-wow-delay=="0.7s">Aritro Maji</h2>
                ...
                <section class="col-md-6 col-sm-6">
                    <div class="team-member wow animated fadeIn legible" data-wow-delay=="0.3s" style="position:relative;">
                        <img src="static/img/propic.jpg" class="img_res team-pic" style="position:relative;left:50%;margin-left:-75px;height:125px;width:125px;">
                        <h2 class="wow animated fadeInDown" data-wow-delay=="0.7s">Ravi Kumar</h2>
                        <p class="wow animated fadeIn" data-wow-delay=="0.7s">
