        ...
        <section class="container">
            <section class="row" id="logo_menu" role="navigation">                  
                <div class="col-md-2 col-sm-8 col-xs-2 navbar-brand">
                    <a class="logo" href=""><i class="ion-ios-home hidden-md hidden-lg"></i><span class="hidden-sm hidden-xs" style="letter-spacing:2px;font-weight:bold;">IDP</span></a>
                </div>
            ...
            <section class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="headings">
                        ...
                        <p class="wow animated fadeInLeft" style="background:rgba(0,0,0,.7);">A platform to put our imagination at work; a challenge to innovate and find solutions</p>
                        <div class="row">
